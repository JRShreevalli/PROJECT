...
-- used to display the current values of various server system variables
-- These variables control the behavior and configuration of the MySQL server, covering aspects like storage, security, 
-- networking, query optimization, etc.
-- It tells the server to only display the system variables whose names match the pattern 'local_infile'

LOAD DATA LOCAL INFILE 'C:/UPGRADE/Data Science/C2_Data_Toolkit/SQL_Graded_Group_Assessment/SQL_Assg_PMFBY_Dataset_Starter/Data_PMFBY/data.csv'
